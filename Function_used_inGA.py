...
def objective_value(x,y,chromosome):  
    
    # x = c
    lb_x = 1.0 # lower bound for chromosome x
    ub_x = 100.0 # upper bound for chromosome x
    len_x = (len(chromosome)//2) # length of chromosome x
    
    # y = gamma
    lb_y = 100 # lower bound for chromosome y
    ub_y = 1000 # upper bound for chromosome y
    ...
    k_hyperparameter = (x_bit_sum*precision_x)+lb_x
    s_hyperparameter = (y_bit_sum*precision_y)+lb_y
...
# =============================================================================
    ...
    classifier = ClassifierChain(LogisticRegression(C=k_hyperparameter, max_iter=s_hyperparameter))
...
# =============================================================================
# 
#     mlknn_classifier = MLkNN(k=k_hyperparameter,s=s_hyperparameter)
...
#         
#         model = MLkNN(k=k_hyperparameter,s=s_hyperparameter)
...
# =============================================================================
    ...
    return k_hyperparameter,s_hyperparameter,error
...
def find_parents_ts(all_solutions,x,y):
    ...
    # parents array has same columns as that of all_solutions
    ...
    for i in range(2): # do the process twice to get 2 parents
        ...
        obj_func_parent_1 = objective_value(x,y,chromosome=posb_parent_1)[2] # possible parent 1
        obj_func_parent_2 = objective_value(x,y,chromosome=posb_parent_2)[2] # possible parent 2
        obj_func_parent_3 = objective_value(x,y,chromosome=posb_parent_3)[2] # possible parent 3
